...
export function doClaimRibbon(scaffold: ExtensionScaffoldApi) {
  ...
  claimRibbonThen(scaffold, 'mp.general.area', div => {
    ReactDOM.render(
      <React.StrictMode>
        <es-ribbon-section name="General Area">
          <es-ribbon-button name="New Area">
            <PlusSquareO />
          </es-ribbon-button>
          <es-ribbon-button name="Edit Summary">
          ...
          <es-ribbon-button name="Area Filters">
            <svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1595 295q17 41-14 70l-493 493v742q0 42-39 59-13 5-25 5-27 0-45-19l-256-256q-19-19-19-45v-486l-493-493q-31-29-14-70 17-39 59-39h1280q42 0 59 39z"/></svg>
          </es-ribbon-button>
          <es-ribbon-button name="Static Areas">
          ...
          <es-ribbon-button name="Dynamic Areas">
            <svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M896 1629l640-349v-636l-640 233v752zm-64-865l698-254-698-254-698 254zm832-252v768q0 35-18 65t-49 47l-704 384q-28 16-61 16t-61-16l-704-384q-31-17-49-47t-18-65v-768q0-40 23-73t61-47l704-256q22-8 44-8t44 8l704 256q38 14 61 47t23 73z"/></svg>
          </es-ribbon-button>
        </es-ribbon-section>
      </React.StrictMode>,
  ...
  claimRibbonThen(scaffold, 'mp.asw.search.planning', div => {
    ReactDOM.render(
      <React.StrictMode>
        <es-ribbon-section name="ASW Search Planning">
          <es-ribbon-button name="SPA">
  ...
  claimRibbonThen(scaffold, 'mp.review', div => {
    ReactDOM.render(
      <React.StrictMode>
        <es-ribbon-section name="Review">
          <es-ribbon-button name="Interference Check">
          ...
          <es-ribbon-button name="Sign Plan">
          ...
          <es-ribbon-button name="Manage Reviewers">
          ...
          <es-ribbon-button name="Export Plan">
  ...
  claimRibbonThen(scaffold, 'mp.messages', div => {
    ReactDOM.render(
      <React.StrictMode>
        <es-ribbon-section name="Messages">
          <es-ribbon-button name="New Message">
            <PlusSquareO />
          </es-ribbon-button>
          <es-ribbon-button name="Download">
